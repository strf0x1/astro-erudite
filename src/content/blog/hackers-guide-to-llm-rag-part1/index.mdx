...
Imagine for a moment, a vast, privately curated knowledgebase that you control and use. It could be like a second brain or an evolution of note-taking software. By the end of part 2 of this series, we’ll have something like that you can build to work the way you want it to work, with your privately collected data.
...
For example, you could write phishing emails with python and [ollama](https://ollama.com/). It could even dynamically generate parts of the html:
