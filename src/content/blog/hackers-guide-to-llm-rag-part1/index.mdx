...
I've always wanted a search engine for things like the VX Underground papers archive. It's an amazing resource for but there isn't a great way to search through the data.
