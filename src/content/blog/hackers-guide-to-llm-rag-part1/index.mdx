...
They're also great for some tasks but maybe not ideal for everything, so they shouldn't be looked at as another magic easy button.
...
The community also needs people who are deeply curious about how things actually work and willing to redteam these models.
...
There are many open-source, locally-hosted language models you can use right at home that work just as well as ChatGPT, but with the added benefit that you control your own data, without API limits or additional costs.
